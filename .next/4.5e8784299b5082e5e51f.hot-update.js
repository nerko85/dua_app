...
function (_Component) {
  ...
  _createClass(DuaWrapper, [{
    ...
    value: function onHandleChange(e) {
      ...
      console.log(duas); // const results = duas.filter(dua => {
      //     const regex = new RegExp(value, 'gi')
      //     return dua.name.match(regex) || dua.body.match(regex)
      // })
      // console.log(results);
    }
  }, {
...
//# sourceMappingURL=4.5e8784299b5082e5e51f.hot-update.js.map