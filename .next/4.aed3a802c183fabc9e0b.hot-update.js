...
function (_Component) {
  ...
  _createClass(DuaWrapper, [{
    ...
    value: function (_fetch) {
      ...
      var endpoint = ' http://api.aladhan.com/v1/calendar?latitude=51.508515&longitude=-0.1254872&method=2&month=4&year=2017 ';
    ...
    value: function render() {
      ...
      }, novo), prayers.map(function (prayer) {
        return "\n                            <p>".concat(prayer.date.readable, "</p>\n                        ");
      }));
    }
  }]);
...
//# sourceMappingURL=4.aed3a802c183fabc9e0b.hot-update.js.map